...
public class AwsS3Service extends AbstractLifecycleComponent<AwsS3Service> {
    ...
    public synchronized AmazonS3 client(EncryptionMaterials clientSideEncryptionMaterials) {
        String endpoint = getDefaultEndpoint();
        String account = componentSettings.get("access_key", settings.get("cloud.account"));
        String key = componentSettings.get("secret_key", settings.get("cloud.key"));
        return getClient(endpoint, account, key, clientSideEncryptionMaterials);
    }

    public synchronized AmazonS3 client(String region, String account, String key, EncryptionMaterials clientSideEncryptionMaterials) {
        String endpoint;
        if (region == null) {
    ...
    private synchronized AmazonS3 getClient(String endpoint, String account, String key, EncryptionMaterials clientSideEncryptionMaterials) {
        Tuple<String, Tuple<String, EncryptionMaterials>> clientDescriptor = new Tuple<String, Tuple<String, EncryptionMaterials>>(endpoint, new Tuple<String, EncryptionMaterials>(account, clientSideEncryptionMaterials));
