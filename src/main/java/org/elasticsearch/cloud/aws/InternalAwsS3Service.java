...
public class InternalAwsS3Service extends AbstractLifecycleComponent<AwsS3Service> implements AwsS3Service {
    ...
    public synchronized AmazonS3 client() {
        ...
        return getClient(endpoint, account, key, null, null);
    }

    @Override
    public AmazonS3 client(String region, String account, String key) {
        return client(region, account, key, null, null);
    }

    @Override
    public AmazonS3 client(String region, String account, String key, Integer maxRetries) {
        return client(region, account, key, maxRetries);
    }

    @Override
    public synchronized AmazonS3 client(String region, String account, String key, Integer maxRetries, EncryptionMaterials clientSideEncryptionMaterials) {
        String endpoint;
        if (region == null) {
        ...
        return getClient(endpoint, account, key, maxRetries, clientSideEncryptionMaterials);
    }


    private synchronized AmazonS3 getClient(String endpoint, String account, String key, Integer maxRetries, EncryptionMaterials clientSideEncryptionMaterials) {
