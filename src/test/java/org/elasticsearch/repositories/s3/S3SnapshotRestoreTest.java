...
public class S3SnapshotRestoreTest extends AbstractAwsTest {
    ...
    public void testClientSideEncryption() throws NoSuchAlgorithmException {
        ...
        String symmetricEncryptionKeyBase64 = Base64.encodeBytes(keyGenerator1.generateKey().getEncoded());
        ...
        String publicEncryptionKeyBase64 = Base64.encodeBytes(keyPair.getPublic().getEncoded());
        String privateEncryptionKeyBase64 =  Base64.encodeBytes(keyPair.getPrivate().getEncoded());
